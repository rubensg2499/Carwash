...
public class utilidades {
    ...
    public static final String APELLIDO_PATERNO_CLIENTE = "apellido_pat";
    public static final String APELLIDO_MATERNO_CLIENTE = "apellido_mat";
    ...
    public static final String CREAR_TABLA_CLIENTE = "CREATE TABLE "+TABLA_CLIENTE+" ("+NOMBRE_CLIENTE+" TEXT NOT NULL,"+APELLIDO_PATERNO_CLIENTE+" TEXT, "+APELLIDO_MATERNO_CLIENTE+" TEXT,"+TELEFONO_CLIENTE+" TEXT,"+PLACAS_VEHICULO+" TEXT NOT NULL,"+MARCA_VEHICULO+" TEXT,"+TIPO_VEHICULO+" TEXT,"+MODELO_VEHICULO+" TEXT, PRIMARY KEY("+PLACAS_VEHICULO+"))";
    public static final String CREAR_TABLA_INSUMO = "CREATE TABLE "+TABLA_INSUMO+" ("+CODIGO_INSUMO+" TEXT NOT NULL,"+NOMBRE_INSUMO+" TEXT NOT NULL,"+PRECIO_UNITARIO_INSUMO+" INTEGER NOT NULL DEFAULT 0,"+CANTIDAD_INSUMO+" INTEGER NOT NULL DEFAULT 0,"+DESCRIPCION_INSUMO+" TEXT, PRIMARY KEY("+CODIGO_INSUMO+"))";
    public static final String CREAR_TABLA_SERVICIO = "CREATE TABLE "+TABLA_SERVICIO+" ("+CODIGO_SERVICIO+" TEXT NOT NULL,"+NOMBRE_SERVICIO+" TEXT NOT NULL,"+COSTO_SERVICIO+" INTEGER NOT NULL DEFAULT 0,"+DESCRIPCION_SERVICIO+" TEXT NOT NULL, PRIMARY KEY("+CODIGO_SERVICIO+"))";
